# Bootstrappable ninacatcoin Builds

This directory contains the files necessary to perform bootstrappable ninacatcoin 
builds.
...
To build ninacatcoin reproducibly with all default options, invoke the
...
repository](https://github.com/ninacatcoin-project/guix.sigs).
