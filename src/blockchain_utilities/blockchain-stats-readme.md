# ninacatcoin Blockchain Stats

ninacatcoin Blockchain Stats utlity exports daily statistics for the ninacatcoin blockchain from creation through current state.

## Usage:

See also the utility's help option. `ninacatcoin-blockchain-stats --help`
...
- `ninacatcoin-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `ninacatcoin-blockchain-stats | save-to-database.sh`
