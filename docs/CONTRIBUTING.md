...
posted to #ninacatcoin-dev on irc.libera.chat).
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Ninacatcoin code or Ninacatcoin's dependency code or Ninacatcoin's potential/future dependency code or research which successfully implements Ninacatcoin.
...
- Maintainers SHOULD NOT merge their own patches unless they were added to the merge queue on irc and have at least 3 approvals from contributors OR unless urgent as defined by the Ninacatcoin Maintainers Team.
...
- The Ninacatcoin Core Team MUST act as Administrators to manage the set of project Maintainers.
