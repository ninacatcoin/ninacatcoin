Ninacatcoin daemon internationalization
==================================
...
```bash
cp translations/ninacatcoin.ts translations/ninacatcoin_es.ts
```

To edit translations for Spanish:

```bash
linguist translations/ninacatcoin_es.ts
```
...
```bash
LANG=es ./build/release/bin/ninacatcoin-wallet-cli
```
